...
import { requestPasswordReset } from "../util/axios";

export default function EnterEmail() {
    const [email, setEmail] = useState("");
    const [error, setError] = useState("");
    const [loading, setLoading] = useState(false);
    const [otpGenerated, setOtpGenerated] = useState(null); // Store OTP from response
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Store OTP from response for display
            if (response.data.otp) {
                setOtpGenerated(response.data.otp);
            }

            // Navigate to OTP screen on success after showing OTP
            setTimeout(() => {
                navigate("/verify-otp", { state: { email } });
            }, 3000); // Give user 3 seconds to see the OTP
        } catch (err) {
            ...
            >
                ...
                <div className="relative bg-primary-600 px-8 py-10 text-white overflow-hidden">
                    ...
                    <div className="relative flex flex-col items-center">
                        ...
                        <p className="text-primary-100/80 mt-1 font-medium text-sm">Enter your email to continue</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {otpGenerated && (
                            <motion.div
                                ...
                                className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-6 rounded-2xl"
                            >
                                ...
                                <div className="bg-white rounded-xl p-4 border border-green-100">
                                    <p className="text-xs text-slate-500 mb-2 font-semibold">Your OTP Code:</p>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => {
                                                navigator.clipboard.writeText(otpGenerated);
                                ...
                                <p className="text-xs text-green-700 mt-3 font-medium">
                                    ✓ Check your email or use the code above • Redirecting to OTP verification...
                                </p>
                            </motion.div>
                        )}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="admin@lakshmihall.com"
